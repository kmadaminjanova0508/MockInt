...
export const LampContainer = ({
  ...
  return (
    (<div
      className={cn(
        "relative flex flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0 pt-[200px]",
        className
      )}>
      <div
        className="relative hidden lg:flex  w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
